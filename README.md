...
> 주어진 데이터셋을 살펴본 결과 분석할 수 있는 '주요 Factor' 4가지 가정해 보았다.
> 그 4가지 Factor(요인)를 가지고 교육기업의 비즈니스 모델을 추론하고자 계획, 추론한 비즈니스모델을 가지고 특징과 강점 및 약점을 파악, 궁극적으로 매출에 어떻게 영향을 미치는지 살펴보고자 했다.
> 결과적으로 분석결과에서 마케팅, 컨텐츠제작, 운영 등 여러관점으로 인사이트를 얻고자 했다.
...
<p align="center"><img src="assets/g03.png" width="280"></p>
